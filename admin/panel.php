    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="panel.php?modulo=&sesion=cerrar" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="dist/img/cerrarsesion.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      <img src="dist/img/favicon.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Monet ecommerce</span>
    </a>
...
<script>
  $(document).ready(function (){
    $(".borrar").click(function (e){
      e.preventDefault();
      var res=confirm("Desea borrar este usuario");
      if(res==true){
